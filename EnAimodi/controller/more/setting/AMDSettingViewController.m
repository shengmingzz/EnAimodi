...
@interface AMDSettingViewController ()
{
    NSArray *arraySetting;
}
@end

@implementation AMDSettingViewController
-(void) dealloc
{
...
- (void)viewDidLoad
{
    ...
    arraySetting = [[NSArray alloc] initWithObjects:@"通知推送",@"提示文字颜色",@"学习提醒",nil];
}
